...
class AdminAction extends CommonAction {
    ...
    private $create_fields = array('username', 'password', 'role_id', 'mobile','area_id','city_id','proportions');
    private $edit_fields = array('password', 'role_id', 'mobile','area_id','city_id','proportions');
    ...
    public function index() {
        ...
        foreach ($list as $k => $val) {
            ...
            $city = M('city')
                    ...
                    ->field('name')
                    ->find();
            $val['name'] = $city['name'] ? $city['name'] : '全部';
            // 区域
            $area = M('area')
                    ->where('area_id = '.$val['area_id'])
                    ->field('area_name')
                    ->find();
            $val['area_name'] = $area['area_name'] ? $area['area_name'] : '全部';
