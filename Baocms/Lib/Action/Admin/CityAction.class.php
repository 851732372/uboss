...
class CityAction extends CommonAction {
    ...
    private $create_fields = array('name', 'pinyin', 'is_open', 'lng', 'lat','orderby','first_letter','proportions');
    private $edit_fields = array('name', 'pinyin', 'is_open', 'lng', 'lat','orderby','first_letter','proportions');
    ...
    private function createCheck() {
        ...
        $data['proportions'] = (int)($data['proportions']);
        return $data;
    }
