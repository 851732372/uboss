...
class WxpaybaseAction extends CommonAction
{
    const KEY = '2trc3wdnorzs5jdxf1ebfiepgjhlpml4'; //支付秘钥需要更改成自己的
    const APPID = 'wxece7fccd7def1e55'; //APPID需要更改为自己的
    const MCHID = '1488972442'; //商户号需要更改成自己的
    const REFUND = 'https://api.mch.weixin.qq.com/secapi/pay/refund';
    const SECRET = '919a2c069b07190863f15ec96a2e4985'; //开发者密码需要更改为自己的
