...
require_cache(APP_PATH . 'Extend/alipay/SignData.php');
/**
 * File name: alicashAction.class.php
 * 文件描述
 * Created on: 2018/10/16 23:14
 * Created by: Ginger.
 */

class AlicashAction extends BaseAction
{
    ...
    public function userWithDraw(){            //支付宝转账
        require_cache(APP_PATH . 'Extend/alipay/Config.php');
//        require_cache(APP_PATH . 'Extend/alipay/RestConfig.php');
        require_cache(APP_PATH . 'Extend/alipay/AopClient.php');
        require_cache(APP_PATH . 'Extend/alipay/AlipayTradeService.php');
        require_cache(APP_PATH . 'Extend/alipay/AlipayTradeWapPayContentBuilder.php');
        require_cache(APP_PATH . 'Extend/alipay/AlipayFundTransToaccountTransferRequest.php');
        $config = array(
            //应用ID,您的APPID。
...
//        $config = Config::config();
        ...
        $aop->appId = '2018090161244107';
        $aop->rsaPrivateKey = "";
            //'';
        $aop->alipayrsaPublicKey= "";
            //'';
        $aop->apiVersion = '1.0';
        $aop->signType = 'RSA2';
        ...
        //查数据库调取提现金额
//        $withdraw = M('withdraw');
//        $withdrawData = $withdraw->where(['id'=>$id])->find();
        //查询提现用户
//        $alipay = M('users_alipay');
//        $alipayData = $alipay->where(['user_id'=>$withdrawData['user_id']])->find();

        $txmoney = 10;bcmul(10 , (100 - 2 ) * 0.01,2);
        $out_biz_no = 123;
        $payee_account = '18792598172';
        $payee_man = '姜鹏军';
