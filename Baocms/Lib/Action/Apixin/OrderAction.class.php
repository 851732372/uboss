...
//            }
            ...
            $list = $orderModel
                ->field('o.order_id id,og.goods_id goodsId,g.title goodsName,o.shop_id shopId,s.shop_name shopName,o.status,g.photo picture,o.create_time orderTime,o.total_price payment,s.cate_id categoryId')
    ...
    private function detail()
    {
        if ($this->isPost())
        {
            ...
            $order = D('Order o')
                ...
                o.success_time consumeTime,og.num,o.original_price total,o.bookinfo')
                ->join('uboss_order_goods og ON og.order_id = o.order_id')
                ->join('uboss_goods g ON g.goods_id = og.goods_id')
