...
class CommonAction extends Action {
    ...
    private function parseTemplate($template = '') {
        ...
        define('NOW_PATH',BASE_PATH.'/themes/'.$theme.'Shangjia1/');
        // 获取当前主题的模版路径
        define('THEME_PATH', BASE_PATH . '/themes/default/Shangjia1/');
        define('APP_TMPL_PATH', __ROOT__ . '/themes/default/Shangjia1/');
