...
class GoodsAction extends CommonAction {
    ...
    private $create_fields = array('title', 'photo', 'cate_id', 'price', 'shopcate_id', 'mall_price','settlement_price', 'commission','instructions', 'details', 'end_date');
    private $edit_fields = array('title', 'photo', 'cate_id', 'price', 'shopcate_id', 'mall_price', 'settlement_price','commission','instructions', 'details', 'end_date');
