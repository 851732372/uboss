...
class ShopModel extends CommonModel{
    ...
    public function get_proportions($shop_id)
    {
        $proportions = $this->field('shop_id,proportions')->find($shop_id);
	...
	public function getphoto($shop_id,$photo,$rowList = 2)
	{
		$obj = D('Shoppic');
		$pic = $obj->field('photo')->where('shop_id='.$shop_id)->limit(0,$rowList)->select();
		$photos = array();
