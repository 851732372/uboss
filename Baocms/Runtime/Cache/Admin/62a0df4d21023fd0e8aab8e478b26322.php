...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class="main_logon">
            ...
            <div class="login">
                <div class="title" style="width:580px">优BOSS台管理系统</div>
                    ...
                    <table cellpssssadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td><input type="text" name="yzm" class="yzm" placeholder="请输入验证码" />
                                <span class="yzm_code" style="margin:2px 0 0px; display:block; cursor:pointer;"><img style="width:100px; height:38px;"  src="__ROOT__/index.php?g=app&m=verify&a=index&mt=<?php echo time();?>" /></span></td>
                        </tr>
                        <tr>
