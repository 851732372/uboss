    ...
    <div class="panel-body">
    	<table class="table table-bordered">
    		...
    		<tr>
    			...
    			<th>身份证照片</th>
    			<td>
    				<img src="/attachs/<?php echo ($userinfo["idcard_zimgs"]); ?>" alt="" width="150px" height="50px">
    				<img src="/attachs/<?php echo ($userinfo["idcard_fimgs"]); ?>" alt="" width="150px" height="50px"> 
    			</td>
    			<th>昵称</th>
    		...
    		<tr>
    			<th>申请行业</th>
    			<td><?php echo ($founder["cate_name"]); ?></td>
    			<th>店铺类型</th>
    			<td>
    				<?php if(($founder["store_type"]) == "1"): ?>旗舰店<?php endif; ?>
    				<?php if(($founder["store_type"]) == "2"): ?>核心店<?php endif; ?>
    				<?php if(($founder["store_type"]) == "3"): ?>人气店<?php endif; ?>
    			</td>
    			<th>认证状态</th>
    			<td>
    				<?php if(($userinfo["is_reg"]) == "1"): ?><code>已认证</code><?php endif; ?>
    				<?php if(($userinfo["is_reg"]) == "0"): ?><code>未认证</code><?php endif; ?>
    			</td>
    		</tr>
    	</table>
    	<hr>
    	<form action="" method="post" class='form form-horizontal validate-form' target="baocms_frm">
    		...
    		<input type="hidden" name="founder_id" value="<?php echo ($_GET['id']); ?>">
