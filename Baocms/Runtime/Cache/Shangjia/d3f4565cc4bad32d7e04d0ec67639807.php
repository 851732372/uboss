...
<div class="tuan_content">
    ...
    <div class="tabnr_change  show">
        <form method="post" action="<?php echo U('shop/logo');?>"  target="baocms_frm" class='form form-horizontal validate-form' style='margin-bottom: 0;' >
            <style>
                #zyupload{
            ...
            <div class='control-group'>
                ...
                <input type="hidden" name="logo" value="<?php echo ($logo); ?>" id="data_logo" />
                <div class='controls'>
                    <ul class="upload-ul clearfix">
                        <li style="position: relative;">
                                <img src="/attachs/<?php echo ($logo); ?>" style="height:90px" width="120px">
                                <span class="close" style="position: absolute;top:-5px;right:0px;color:#ccc" onclick="deli()">&times;</span>
                        </li>
            ...
            <script>
                $(function(){
                 ...
                 function deli(){
                    $.post('<?php echo U("ajax_del2");?>',{},function(data){
                        location.reload();
                    })
                }
            </script>
