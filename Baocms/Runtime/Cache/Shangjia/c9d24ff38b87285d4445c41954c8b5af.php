...
<div class="tuan_content">
    ...
    <div class="tuanfabu_tab">
        <ul>
            ...
            <li class="tuanfabu_tabli tabli_change  on"><a href="<?php echo U('shop/photo');?>">店铺环境图</a></li>
        </ul>
    </div>
    <div class="tabnr_change  show">
        <form method="post" action="<?php echo U('shop/photo');?>"  target="baocms_frm" class='form form-horizontal validate-form' style='margin-bottom: 0;' >
            <div class='control-group'>
                <label class='control-label' for='validation_ip'>店铺环境图</label>
                <input type="hidden" name="otherimgs" id="img" value="<?php echo ($imgs); ?>">
                <div class='controls'>
                    <ul class="upload-ul clearfix">
                        ...
                        <?php if(is_array($otherimgs)): $i = 0; $__LIST__ = $otherimgs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i; if(!empty($otherimgs)){ ?>
                            <li style="position: relative;">
                                <img src="/attachs/<?php echo ($img); ?>" style="height:90px" width="120px" height="90px"> <span class="close" style="position: absolute;top:0px;right:0px;color:black" onclick="deli(this,<?php echo ($key); ?>)">&times;</span>
                            </li>
            ...
            <script>
                ...
                function deli(obj,key){
                    $.post('<?php echo U("ajax_del");?>',{key:key},function(data){
                        $(obj).parent().remove();
                        location.reload();
                    })
                }
